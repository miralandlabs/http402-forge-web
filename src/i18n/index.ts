export const en = {
  ...
  fieldDisplayNamePlaceholder: "Studio or agent name shown to buyers",
  escrowSizeWarning:
    "Files at or above {max} are not accepted yet (escrow lane deferred). Compress or split your file.",
  fieldAssetHintEscrow: "Max {max} on exact lane — larger files wait for escrow (Phase 3)",
  manageListingsTitle: "My listings",
  manageListingsHint: "Listings published from your connected wallet.",
  manageListingsConnect: "Connect your wallet to see listings you published.",
  manageListingsEmpty: "No active listings for this wallet.",
  manageListingsStatus: "Delivery",
  manageListingsActions: "Actions",
  filterAgentFriendly: "Agent-friendly",
  loadMore: "Load more",
  browseShowing: "Showing",
  feedbackModalTitle: "How was the download?",
  feedbackModalHint: "Your feedback helps other buyers and agents (one response per purchase).",
  feedbackAsDescribed: "As described",
  feedbackCorrupt: "Corrupt file",
  feedbackMisleading: "Misleading listing",
  feedbackSkip: "Skip",
  feedbackHashOk: "SHA-256 matches the listing content hash.",
  feedbackHashMismatch: "SHA-256 does not match the published content hash.",
  feedbackThanks: "Thanks — feedback recorded.",
  myPurchasesTitle: "My purchases",
  myPurchasesHint: "Paid downloads for your connected wallet. Re-download anytime with wallet signature.",
  myPurchasesConnect: "Connect your wallet to see purchases you paid for.",
  myPurchasesEmpty: "No purchases yet for this wallet.",
  myPurchasesRedownload: "Re-download",
  myPurchasesFeedback: "Feedback",
  purchasedAt: "Purchased",
  listingRemoved: "delisted",
} as const;
...
export const zh: Record<MessageKey, string> = {
  ...
  fieldDisplayNamePlaceholder: "向买家展示的工作室或智能体名称",
  escrowSizeWarning:
    "暂不接受 {max} 及以上的文件（托管通道尚未开放）。请压缩或拆分文件。",
  fieldAssetHintEscrow: "即时通道上限 {max} — 更大文件需等待托管通道（第三阶段）",
  manageListingsTitle: "我的商品",
  manageListingsHint: "当前连接钱包发布的商品。",
  manageListingsConnect: "连接钱包以查看您发布的商品。",
  manageListingsEmpty: "此钱包暂无在售商品。",
  manageListingsStatus: "交付方式",
  manageListingsActions: "操作",
  filterAgentFriendly: "Agent 友好",
  loadMore: "加载更多",
  browseShowing: "显示",
  feedbackModalTitle: "下载体验如何？",
  feedbackModalHint: "您的反馈帮助其他买家与智能体（每笔购买仅可提交一次）。",
  feedbackAsDescribed: "与描述一致",
  feedbackCorrupt: "文件损坏",
  feedbackMisleading: "描述不符",
  feedbackSkip: "跳过",
  feedbackHashOk: "SHA-256 与商品内容哈希一致。",
  feedbackHashMismatch: "SHA-256 与公布的内容哈希不一致。",
  feedbackThanks: "感谢 — 反馈已记录。",
  myPurchasesTitle: "我的购买",
  myPurchasesHint: "当前连接钱包的已付下载。随时可用钱包签名重新下载。",
  myPurchasesConnect: "连接钱包以查看您已付款的购买记录。",
  myPurchasesEmpty: "此钱包暂无购买记录。",
  myPurchasesRedownload: "重新下载",
  myPurchasesFeedback: "反馈",
  purchasedAt: "购买时间",
  listingRemoved: "已下架",
};
